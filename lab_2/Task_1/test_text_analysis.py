...
class MyTest(unittest.TestCase):
    def test_sentence_expr(self):
        ...
        self.assertTrue(re.match(t_a.sentence_template, "I am a sentence with numbers, also i have 1 comma."))
        ...
        self.assertEqual(len(re.findall(t_a.sentence_template, "I am the first sentence. And i am Mr. & Mss. Smith the second one.")), 2)
